...
const SelectGroupMolecule = (props) => (
  <div className="SelectGroupMolecule" data-testid="SelectGroupMolecule">
    ...
    <div className='select-wrapper'>
      <SelectAtom setCurrentFocusedElement={props.setCurrentFocusedElement} elementRef={props.elementRef} {...props.creditCardExpirationDateMonth}></SelectAtom>
    </div>
    <div className='select-wrapper'>
      <SelectAtom setCurrentFocusedElement={props.setCurrentFocusedElement} elementRef={props.elementRef} {...props.creditCardExpirationDateYear}></SelectAtom>
    </div>
  </div>
);
